...
public class OpportunitySorting extends BaseClass {
	...
	public void oppSorting() throws InterruptedException, ParseException {
		...
		WebElement option = driver
				.findElement(By.xpath("(//button[@class='slds-button slds-button_icon slds-button_icon-more'])[2]"));
		option.click();
		WebElement table = driver.findElement(
				By.xpath("//*[@id='brandBand_1']/div/div/div/div/div[1]/div[2]/div[3]/div[2]/div/div/ul/li[1]/a/span"));
		table.click();
